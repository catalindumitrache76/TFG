...
\par
Si bien es cierto que el sistema operativo donde se desarrollase el proyecto no era un requisito, se contempló desde los inicios del proyecto como un pre-requisito recomendado por el director del proyecto. Se propuso un sistema operativo \textit{LINUX} \cite{wikilinux} sobre el que llevar a cabo la implementación de la solución debido a las restricciones presupuestarias mencionadas en la fase de análisis. 
