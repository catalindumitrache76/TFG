\chapter{Contexto, motivación y restricciones} \label{phytoscheme}
...
[Figura \ref{fig:flujo_actual_importacion}:] *SGHVF = Subdirección General de Higiene Vegetal y Forestal
