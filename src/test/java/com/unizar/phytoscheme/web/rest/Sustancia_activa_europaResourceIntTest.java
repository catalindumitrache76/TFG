...
public class Sustancia_activa_europaResourceIntTest {
    ...
    public void setup() {
        ...
        Sustancia_activa_europaResource sustancia_activa_europaResource = new Sustancia_activa_europaResource(sustancia_activa_europaRepository, sustancia_activa_europaSearchRepository);
